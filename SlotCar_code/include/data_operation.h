...
// DEFINITIONS
    /* Correlation */
#define DUMP_SAMPLES 100                    // Specify number of fed samples into the algorithm to be dumped at the beginning
#define CORRELATION_WINDOW 300              // Number of samples for reference lap
...
#define CORRELATION_SAD_THRESHOLD 1000      // SAD threshold, the close to 0 the higher the match
